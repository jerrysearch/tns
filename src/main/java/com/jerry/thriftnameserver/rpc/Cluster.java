...
public class Cluster {
  ...
  public interface Iface {
     ...
     * @param instanceName
     */
    public void onLine(String host, int port, String instanceName) throws org.apache.thrift.TException;
     ...
     * @param clientId
     */
    public Map<String,List<SNode>> allServiceList(String clientId) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void onLine(String host, int port, String instanceName, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void onLine(String host, int port, String instanceName) throws org.apache.thrift.TException
    {
      send_onLine(host, port, instanceName);
    }

    public void send_onLine(String host, int port, String instanceName) throws org.apache.thrift.TException
    {
    ...
    public Map<String,List<SNode>> recv_allServiceList() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void onLine(String host, int port, String instanceName, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      onLine_call method_call = new onLine_call(host, port, instanceName, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class onLine_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public onLine_call(String host, int port, String instanceName, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class allServiceList_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public Map<String,List<SNode>> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class onLine<I extends Iface> extends org.apache.thrift.ProcessFunction<I, onLine_args> {
      ...
      public org.apache.thrift.TBase getResult(I iface, onLine_args args) throws org.apache.thrift.TException {
        iface.onLine(args.host, args.port, args.instanceName);
        return null;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class onLine<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, onLine_args, Void> {
      ...
      public void start(I iface, onLine_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.onLine(args.host, args.port, args.instanceName,resultHandler);
      }
    }

    public static class allServiceList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, allServiceList_args, Map<String,List<SNode>>> {
      public allServiceList() {
        super("allServiceList");
      }
      ...
      public AsyncMethodCallback<Map<String,List<SNode>>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<Map<String,List<SNode>>>() { 
          public void onComplete(Map<String,List<SNode>> o) {
            allServiceList_result result = new allServiceList_result();
            result.success = o;
            try {
      ...
      public void start(I iface, allServiceList_args args, org.apache.thrift.async.AsyncMethodCallback<Map<String,List<SNode>>> resultHandler) throws TException {
  ...
  public static class onLine_args implements org.apache.thrift.TBase<onLine_args, onLine_args._Fields>, java.io.Serializable, Cloneable, Comparable<onLine_args>   {
    ...
    public onLine_args setInstanceName(String instanceName) {
      this.instanceName = instanceName;
      return this;
    }
  ...
  public static class allServiceList_result implements org.apache.thrift.TBase<allServiceList_result, allServiceList_result._Fields>, java.io.Serializable, Cloneable, Comparable<allServiceList_result>   {
    ...
    public Map<String,List<SNode>> success; // required
    ...
    public allServiceList_result(allServiceList_result other) {
      if (other.isSetSuccess()) {
        Map<String,List<SNode>> __this__success = new HashMap<String,List<SNode>>(other.success.size());
        for (Map.Entry<String, List<SNode>> other_element : other.success.entrySet()) {

          String other_element_key = other_element.getKey();
          List<SNode> other_element_value = other_element.getValue();

          String __this__success_copy_key = other_element_key;

          List<SNode> __this__success_copy_value = new ArrayList<SNode>(other_element_value.size());
          for (SNode other_element_value_element : other_element_value) {
    ...
    public void putToSuccess(String key, List<SNode> val) {
      if (this.success == null) {
        this.success = new HashMap<String,List<SNode>>();
      }
      this.success.put(key, val);
    }

    public Map<String,List<SNode>> getSuccess() {
      return this.success;
    }

    public allServiceList_result setSuccess(Map<String,List<SNode>> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((Map<String,List<SNode>>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.success = new HashMap<String,List<SNode>>(2*_map0.size);
                  String _key1;
                  List<SNode> _val2;
                  for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                  {
                    _key1 = iprot.readString();
                    {
                      ...
                      _val2 = new ArrayList<SNode>(_list4.size);
                      SNode _elem5;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, allServiceList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<SNode>> _iter7 : struct.success.entrySet())
            {
              oprot.writeString(_iter7.getKey());
              {
                ...
                for (SNode _iter8 : _iter7.getValue())
                {
                  _iter8.write(oprot);
                }
                oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Map.Entry<String, List<SNode>> _iter9 : struct.success.entrySet())
            {
              oprot.writeString(_iter9.getKey());
              {
                oprot.writeI32(_iter9.getValue().size());
                for (SNode _iter10 : _iter9.getValue())
                {
                  _iter10.write(oprot);
                }
              }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashMap<String,List<SNode>>(2*_map11.size);
            String _key12;
            List<SNode> _val13;
            for (int _i14 = 0; _i14 < _map11.size; ++_i14)
            {
              _key12 = iprot.readString();
              {
                ...
                _val13 = new ArrayList<SNode>(_list15.size);
                SNode _elem16;
