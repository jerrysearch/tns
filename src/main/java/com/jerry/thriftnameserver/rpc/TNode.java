...
public class TNode implements org.apache.thrift.TBase<TNode, TNode._Fields>, java.io.Serializable, Cloneable, Comparable<TNode> {
  ...
  static {
    schemes.put(StandardScheme.class, new TNodeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TNodeTupleSchemeFactory());
  }
  ...
  public TNode setHost(String host) {
    this.host = host;
    return this;
  }
  ...
  public TNode setInstanceName(String instanceName) {
    this.instanceName = instanceName;
    return this;
  }
  ...
  public TNode setVNodes(int vNodes) {
    this.vNodes = vNodes;
    setVNodesIsSet(true);
    return this;
  }
  ...
  private static class TNodeStandardSchemeFactory implements SchemeFactory {
    public TNodeStandardScheme getScheme() {
      return new TNodeStandardScheme();
    }
  }

  private static class TNodeStandardScheme extends StandardScheme<TNode> {
  ...
  private static class TNodeTupleSchemeFactory implements SchemeFactory {
    public TNodeTupleScheme getScheme() {
      return new TNodeTupleScheme();
    }
  }

  private static class TNodeTupleScheme extends TupleScheme<TNode> {
