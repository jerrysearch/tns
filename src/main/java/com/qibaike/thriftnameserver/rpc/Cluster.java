...
public class Cluster {
  ...
  public interface Iface {
     ...
     * @param cnode
     */
    public void up(com.qibaike.thriftnameserver.rpc.TCNode cnode) throws org.apache.thrift.TException;
     ...
     * @param sList
     */
    public void pushClusterAndServiceList(List<com.qibaike.thriftnameserver.rpc.TCNode> cList, List<com.qibaike.thriftnameserver.rpc.TSNode> sList) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void up(com.qibaike.thriftnameserver.rpc.TCNode cnode, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void pushClusterAndServiceList(List<com.qibaike.thriftnameserver.rpc.TCNode> cList, List<com.qibaike.thriftnameserver.rpc.TSNode> sList, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_up(com.qibaike.thriftnameserver.rpc.TCNode cnode) throws org.apache.thrift.TException
    {
    ...
    public void send_pushClusterAndServiceList(List<com.qibaike.thriftnameserver.rpc.TCNode> cList, List<com.qibaike.thriftnameserver.rpc.TSNode> sList) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class up_call extends org.apache.thrift.async.TAsyncMethodCall {
      private com.qibaike.thriftnameserver.rpc.TCNode cnode;
      public up_call(com.qibaike.thriftnameserver.rpc.TCNode cnode, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class pushClusterAndServiceList_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<com.qibaike.thriftnameserver.rpc.TCNode> cList;
      private List<com.qibaike.thriftnameserver.rpc.TSNode> sList;
      public pushClusterAndServiceList_call(List<com.qibaike.thriftnameserver.rpc.TCNode> cList, List<com.qibaike.thriftnameserver.rpc.TSNode> sList, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.cList = cList;
        this.sList = sList;
      }
  ...
  public static class up_args implements org.apache.thrift.TBase<up_args, up_args._Fields>, java.io.Serializable, Cloneable, Comparable<up_args>   {
    ...
    public com.qibaike.thriftnameserver.rpc.TCNode cnode; // required
    ...
    public up_args(
      com.qibaike.thriftnameserver.rpc.TCNode cnode)
    {
      this();
      this.cnode = cnode;
    }
    ...
    public up_args(up_args other) {
      if (other.isSetCnode()) {
        this.cnode = new com.qibaike.thriftnameserver.rpc.TCNode(other.cnode);
      }
    }
    ...
    public com.qibaike.thriftnameserver.rpc.TCNode getCnode() {
      return this.cnode;
    }

    public up_args setCnode(com.qibaike.thriftnameserver.rpc.TCNode cnode) {
      this.cnode = cnode;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case CNODE:
        if (value == null) {
          ...
          setCnode((com.qibaike.thriftnameserver.rpc.TCNode)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // CNODE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.cnode = new com.qibaike.thriftnameserver.rpc.TCNode();
  ...
  public static class pushClusterAndServiceList_args implements org.apache.thrift.TBase<pushClusterAndServiceList_args, pushClusterAndServiceList_args._Fields>, java.io.Serializable, Cloneable, Comparable<pushClusterAndServiceList_args>   {
    ...
    public List<com.qibaike.thriftnameserver.rpc.TCNode> cList; // required
    public List<com.qibaike.thriftnameserver.rpc.TSNode> sList; // required
    ...
    public pushClusterAndServiceList_args(
      List<com.qibaike.thriftnameserver.rpc.TCNode> cList,
      List<com.qibaike.thriftnameserver.rpc.TSNode> sList)
    {
      this();
      this.cList = cList;
      this.sList = sList;
    ...
    public pushClusterAndServiceList_args(pushClusterAndServiceList_args other) {
      if (other.isSetCList()) {
        List<com.qibaike.thriftnameserver.rpc.TCNode> __this__cList = new ArrayList<com.qibaike.thriftnameserver.rpc.TCNode>(other.cList.size());
        for (com.qibaike.thriftnameserver.rpc.TCNode other_element : other.cList) {
          __this__cList.add(new com.qibaike.thriftnameserver.rpc.TCNode(other_element));
        }
        this.cList = __this__cList;
      }
      if (other.isSetSList()) {
        List<com.qibaike.thriftnameserver.rpc.TSNode> __this__sList = new ArrayList<com.qibaike.thriftnameserver.rpc.TSNode>(other.sList.size());
        for (com.qibaike.thriftnameserver.rpc.TSNode other_element : other.sList) {
          __this__sList.add(new com.qibaike.thriftnameserver.rpc.TSNode(other_element));
        }
    ...
    public java.util.Iterator<com.qibaike.thriftnameserver.rpc.TCNode> getCListIterator() {
      return (this.cList == null) ? null : this.cList.iterator();
    }

    public void addToCList(com.qibaike.thriftnameserver.rpc.TCNode elem) {
      if (this.cList == null) {
        this.cList = new ArrayList<com.qibaike.thriftnameserver.rpc.TCNode>();
      }
      this.cList.add(elem);
    }

    public List<com.qibaike.thriftnameserver.rpc.TCNode> getCList() {
      return this.cList;
    }

    public pushClusterAndServiceList_args setCList(List<com.qibaike.thriftnameserver.rpc.TCNode> cList) {
      this.cList = cList;
      return this;
    }
    ...
    public java.util.Iterator<com.qibaike.thriftnameserver.rpc.TSNode> getSListIterator() {
      return (this.sList == null) ? null : this.sList.iterator();
    }

    public void addToSList(com.qibaike.thriftnameserver.rpc.TSNode elem) {
      if (this.sList == null) {
        this.sList = new ArrayList<com.qibaike.thriftnameserver.rpc.TSNode>();
      }
      this.sList.add(elem);
    }

    public List<com.qibaike.thriftnameserver.rpc.TSNode> getSList() {
      return this.sList;
    }

    public pushClusterAndServiceList_args setSList(List<com.qibaike.thriftnameserver.rpc.TSNode> sList) {
      this.sList = sList;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case C_LIST:
        if (value == null) {
          ...
          setCList((List<com.qibaike.thriftnameserver.rpc.TCNode>)value);
        }
        break;
      ...
      case S_LIST:
        if (value == null) {
          ...
          setSList((List<com.qibaike.thriftnameserver.rpc.TSNode>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.cList = new ArrayList<com.qibaike.thriftnameserver.rpc.TCNode>(_list0.size);
                  com.qibaike.thriftnameserver.rpc.TCNode _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new com.qibaike.thriftnameserver.rpc.TCNode();
                    _elem1.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.sList = new ArrayList<com.qibaike.thriftnameserver.rpc.TSNode>(_list3.size);
                  com.qibaike.thriftnameserver.rpc.TSNode _elem4;
                  for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                  {
                    _elem4 = new com.qibaike.thriftnameserver.rpc.TSNode();
                    _elem4.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pushClusterAndServiceList_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.cList != null) {
          oprot.writeFieldBegin(C_LIST_FIELD_DESC);
          {
            ...
            for (com.qibaike.thriftnameserver.rpc.TCNode _iter6 : struct.cList)
            {
              _iter6.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.sList != null) {
          oprot.writeFieldBegin(S_LIST_FIELD_DESC);
          {
            ...
            for (com.qibaike.thriftnameserver.rpc.TSNode _iter7 : struct.sList)
            {
              _iter7.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetCList()) {
          {
            ...
            for (com.qibaike.thriftnameserver.rpc.TCNode _iter8 : struct.cList)
            {
              _iter8.write(oprot);
            }
          }
        ...
        if (struct.isSetSList()) {
          {
            ...
            for (com.qibaike.thriftnameserver.rpc.TSNode _iter9 : struct.sList)
            {
              _iter9.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.cList = new ArrayList<com.qibaike.thriftnameserver.rpc.TCNode>(_list10.size);
            com.qibaike.thriftnameserver.rpc.TCNode _elem11;
            for (int _i12 = 0; _i12 < _list10.size; ++_i12)
            {
              _elem11 = new com.qibaike.thriftnameserver.rpc.TCNode();
              _elem11.read(iprot);
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.sList = new ArrayList<com.qibaike.thriftnameserver.rpc.TSNode>(_list13.size);
            com.qibaike.thriftnameserver.rpc.TSNode _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = new com.qibaike.thriftnameserver.rpc.TSNode();
              _elem14.read(iprot);
